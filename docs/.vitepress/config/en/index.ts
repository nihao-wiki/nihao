...
export const en = defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      copyright: `Copyright © ${new Date().getFullYear()} Nihao.wiki <br/><a href="https://beian.miit.gov.cn" target="_blank" rel="noreferrer">渝ICP备2024037934号-1</a><br/>渝公网安备50010402001614号`,
    },
  },
});
